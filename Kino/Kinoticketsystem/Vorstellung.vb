...
Public Class Vorstellung
    ...
    'Konstruktor
    Public Sub New(ByVal Startzeit As Integer, ByVal Endzeit As Integer, ByVal Besucher As ArrayList, ByVal Film As Film) 'ByVal Saal As Kinosaal, 'warum ist der Kinosaal der Veranstaltung auskommentiert? 
